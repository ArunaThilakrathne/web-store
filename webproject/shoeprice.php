...
<html lang="en">
  <head>
    ...
    <title>shoeprice</title>
    <!-- Bootstrap -->
	<link href="css/bootstrap.css" rel="stylesheet">
<link href="vertical.css" type="text/css" rel="stylesheet">
  ...
  <body background="images/448001.jpg">
	...
	<script src="js/bootstrap.js"></script>
	  ...
	  <nav class="navbar-fixed-top" style="background-image: url(images/448001.jpg);border: solid 1px #6A6A6A">
		  ...
		  <a href="shoeprice.php" class="nav-link active" style="font-size: 20px;font-weight: 200;color: white;font-family: impact;;padding: 10px;float:left;">Footware details</a>
		  <a href="shirtprice.php" class="nav-link " style="font-size: 20px;font-weight: 200;color: white;font-family: impact;padding: 10px;float:left;">Tshirt details</a>
	...
	if(!isset($_SESSION['username'])){
	  ...
	  $result = $mysqli->query("SELECT * FROM gallery") or die($mysqli->error);
	  }
	 else {
		 $src = $_POST['srct'];
	  $mysqli = new mysqli('localhost','aruna','123456','destination') or die(mysqli_error($mysqli));
	...
	?>
	 ...
	 <div> <center>
	  ...
	  <table class="table" style="width: 75%; margin-top: 100px;">
		  ...
		  <td style="color: aliceblue"><?php echo $row['titlegallery'];?></td>
			  ...
			  <td>
			  <a href="shoeprice.php?edit=<?php echo $row['idgallery']?>" class="btn btn-info">Edit</a>
				  
				  <a href="process.php?delete=<?php echo $row['idgallery'];?>" class="btn btn-danger">Delete</a>
	  ...
	  <form action="process.php" method="POST">
		  ...
		  <div class="form-group">
		  <input type="text" name="price" placeholder="Price"class="form-control" value="<?php echo $prc?>" style="width: 500px; style="width: 500px;>
			  </div>
		  <div class="form-group">
