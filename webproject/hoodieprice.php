  ...
  <body background="images/448001.jpg">
	...
	<script src="js/bootstrap.js"></script>
	    ...
	    <nav class="navbar-fixed-top" style="background-image: url(images/448001.jpg);border: solid 1px #6A6A6A">
		  ...
		  <a href="hoodieprice.php" class="nav-link active" style="font-size: 20px;font-weight: 200;color: white;font-family: impact;padding: 10px;float:left;">Hoodie deatils</a>
	  ...
	  <?php require_once 'processforhoodie.php';?>
	  <?php
	...
	if(!isset($_SESSION['username'])){
	  ...
	  $result = $mysqli->query("SELECT * FROM hoodie") or die($mysqli->error);
	  }
	  ...
	  $result = $mysqli->query("SELECT * FROM hoodie WHERE titlegallery LIKE '$src%'") or die($mysqli->error);
	  }
	...
	?>
	  ...
	  <table class="table" style="width: 75%; margin-top: 140px;">
		  ...
		  <td style="color: aliceblue"><?php echo $row['titlegallery'];?></td>
			  ...
			  <td>
			  <a href="hoodieprice.php?edit=<?php echo $row['idgallery']?>" class="btn btn-info">Edit</a>
				  
				  <a href="processforhoodie.php?delete=<?php echo $row['idgallery'];?>" class="btn btn-danger">Delete</a>
	  ...
	  <center>
	  <form action="processforhoodie.php" method="POST">
