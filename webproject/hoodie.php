...
<html lang="en">
  ...
  <body background="images/s-l1600.jpg" style="background-attachment: fixed">
	  ...
	  <nav class="navbar-fixed-top" style="background-image: url(images/s-l1600.jpg);border: solid 1px #6A6A6A">
		  ...
		  <a href="home.php" class="nav-link " style="font-size: 20px;font-weight: 200;color: white;font-family: impact;;padding: 10px;float:left;">FOOTWARE</a>
		  ...
		  <a href="hoodie.php" class="nav-link active" style="font-size: 20px;font-weight: 200;color: white;font-family: impact;padding: 10px;float:left;">HOODIES</a>
		  <?php
	...
	<section class="home-links" style="background-image: url(images/s-l1600.jpg)">
		...
		<?php	
		 ...
		 // <div class="gallery" style="background-image: url(images/gallery'.$row["imgfullnamegallery"].');">
			...
			$sql = "SELECT * FROM hoodie ORDER BY ordergallery DESC";
		...
		if(isset($_SESSION['username'])){
			...
			<form action="uploadhd.php"  method="POST" enctype="multipart/form-data" >
